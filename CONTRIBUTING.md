...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your
   ...
   git clone https://github.com/<your-username>/current-cli
   # Navigate to the newly cloned directory
   cd current-cli
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/stve/current-cli
   ```
...
4. Commit your changes in logical chunks. Please adhere to these [git commit
   ...
   Be sure to test all source files for style conformance.
...
2. Use a dedicated commit to increment the version. The version needs to be
   added to the CHANGELOG (inc. date), the `package.json`, and `index.js`
   files.
